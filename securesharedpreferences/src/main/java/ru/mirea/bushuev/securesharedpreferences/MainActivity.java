package ru.mirea.bushuev.securesharedpreferences;
...
import ru.mirea.bushuev.securesharedpreferences.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String fileName = "gogol.jpg";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File file = new File(directory, "gogol.jpg");
    ...
    public void loadButton(View view) throws IOException {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.raw.gogol);
